...
|---|---|
| [TechSpec.md](TechSpec.md) | Architecture, pipeline |
| [AppFlow.md](AppFlow.md) | Dashboard + flows |
| [Design.md](Design.md) | Dashboard design |
| [Schema.md](Schema.md) | 6 ORM models |
| [ImplementationPlan.md](ImplementationPlan.md) | Build plan |
| [Tracker.md](Tracker.md) | Task status |
| [Rules.md](Rules.md) | Standards |
| [API.md](API.md) | REST + webhook contracts |
| [SecurityAndCompliance.md](SecurityAndCompliance.md) | HMAC, auth |
| [Testing.md](Testing.md) | 352 tests |
| [Deployment.md](Deployment.md) | Render/Fly/GHA |
